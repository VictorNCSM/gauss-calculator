...
print('Olá! Aqui você vai calcular a equação de gauss, que tem como objetivo compreender o objeto a ser espelhado, o foco do espelho e a posição na qual a imagem será formada, que correspondem, respectivamente, a "p", "F" e "p\'". Ela é dada por 1/f = (1/p) + (1/p\'\n\n')
